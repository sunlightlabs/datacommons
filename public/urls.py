...
urlpatterns = patterns('dc_web.public.views',        
    ...
    # contributions
    url(r'^download/contributions/$', 'search_download', {'search_resource': contributionfilter_handler},  name="data_contributions_download"),
    ...
    # grants
    url(r'^download/grants/$', 'search_download', {'search_resource': grantsfilter_handler},  name="data_grants_download"),
    ...
    # lobbying
    url(r'^download/lobbying/$', 'search_download', {'search_resource': lobbyingfilter_handler},  name="data_lobbying_download"),
    ...
    url(r'^download/contractor_misconduct/$', 'search_download', {'search_resource': contractor_misconduct_filter_handler},  name="data_contractor_misconduct_download"),
    ...
    # epa_echo
    url(r'^download/epa_echo/$', 'search_download', {'search_resource': epafilter_handler},  name="data_epa_echo_download"),
    ...
    # faca
    url(r'^download/faca/$', 'search_download', {'search_resource': facafilter_handler},  name="data_faca_download"),
    ...
    url(r'^download/contributions/bundled/$', 'search_download', {'search_resource': bundlingfilter_handler},  name="data_bundling_download"),
