...
class Grant(models.Model):
    ...
    rec_flag = models.CharField(max_length=1, blank=True)
    ...
    recipient_country_code = models.CharField(max_length=3, blank=True, null=True)
    ...
    principal_place_country_code = models.CharField(max_length=3, blank=True)
