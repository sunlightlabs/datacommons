create table fec_candidate_summaries_12 as select * from fec_candidate_summaries_import limit 0;
create table fec_candidate_summaries_10 as select * from fec_candidate_summaries_import limit 0;
create table fec_candidate_summaries_08 as select * from fec_candidate_summaries_import limit 0;
create table fec_candidate_summaries_06 as select * from fec_candidate_summaries_import limit 0;
create table fec_candidate_summaries_04 as select * from fec_candidate_summaries_import limit 0;
create table fec_candidate_summaries_02 as select * from fec_candidate_summaries_import limit 0;
