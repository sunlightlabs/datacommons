...
drop view if exists fec_committees_allcycles cascade;
...
drop view if exists fec_committee_summaries_allcycles_import;
drop view if exists fec_candidate_summaries_allcycles_import;
