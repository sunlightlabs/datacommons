...
FILE_TYPES = {
    ...
    'indivs': ['cycle','fec_trans_id','contrib_id','contrib','recip_id','org_name','ult_org','real_code','date','amount','street','city','state','zipcode','recip_code','type','cmte_id','other_id','gender','fec_occ_emp','microfilm','occ_ef','emp_ef','source'],
