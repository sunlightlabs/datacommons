...
create index  fara_client_registrant_client                     on fara_client_registrant using gin(to_tsvector('datacommons', client));
create index  fara_client_registrant_registrant_name            on fara_client_registrant using gin(to_tsvector('datacommons', registrant_name));
create index  fara_client_registrant_terminated                 on fara_client_registrant (terminated);
create index  fara_client_registrant_location_of_client         on fara_client_registrant using gin(to_tsvector('datacommons', location_of_client));
create index  fara_client_registrant_description_of_service     on fara_client_registrant using gin(to_tsvector('datacommons', description_of_service));
...
create index  fara_contact_contact_title                      on fara_contact using gin(to_tsvector('datacommons', contact_title));
create index  fara_contact_contact_name                       on fara_contact using gin(to_tsvector('datacommons', contact_name   ));
create index  fara_contact_contact_office                     on fara_contact using gin(to_tsvector('datacommons', contact_office ));
create index  fara_contact_contact_agency                     on fara_contact using gin(to_tsvector('datacommons', contact_agency ));
create index  fara_contact_client                             on fara_contact using gin(to_tsvector('datacommons', client         ));
create index  fara_contact_client_location                    on fara_contact using gin(to_tsvector('datacommons', client_location));
create index  fara_contact_registrant                         on fara_contact using gin(to_tsvector('datacommons', registrant     ));
create index  fara_contact_description                        on fara_contact using gin(to_tsvector('datacommons', description    ));
create index  fara_contact_contact_type                       on fara_contact (contact_type);
create index  fara_contact_employees_mentioned                on fara_contact using gin(to_tsvector('datacommons', employees_mentioned));
...
create index fara_contribution_recipient                        on fara_contribution using gin(to_tsvector('datacommons', recipient                     ));
create index fara_contribution_registrant                       on fara_contribution using gin(to_tsvector('datacommons', registrant                    ));
create index fara_contribution_contributing_individual_or_pac   on fara_contribution using gin(to_tsvector('datacommons', contributing_individual_or_pac));
...
create index fara_disbursement_client                on fara_disbursement using gin(to_tsvector('datacommons', client          ));
create index fara_disbursement_registrant            on fara_disbursement using gin(to_tsvector('datacommons', registrant      ));
create index fara_disbursement_purpose               on fara_disbursement using gin(to_tsvector('datacommons', purpose         ));
create index fara_disbursement_to_subcontractor      on fara_disbursement using gin(to_tsvector('datacommons', to_subcontractor));
