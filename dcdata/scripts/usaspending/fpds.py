...
FPDS_FIELDS = [('unique_transaction_id','unique_transaction_id', None),
                ...
                ('signeddate', 'signedDate', nullable),
                ('effectivedate', 'effectiveDate', nullable),
                ('currentcompletiondate', 'currentCompletionDate', nullable),
                ('ultimatecompletiondate', 'ultimateCompletionDate', nullable),
                ('obligatedamount', 'obligatedAmount', nullable_float),
                ('shelteredworkshopflag', 'shelteredWorkshopFlag', transformFlag),
                ('baseandexercisedoptionsvalue', 'baseAndExercisedOptionsValue',  nullable_float),
                ('veteranownedflag', 'veteranOwnedFlag', transformFlag),
                ('srdvobflag', 'SRDVOBFlag', transformFlag),
                ('baseandalloptionsvalue', 'baseAndAllOptionsValue', nullable_float),
                ...
                ('seatransportation', 'seaTransportation', first_char), # this data is weird, doesn't match other flags--don't really know how to parse 
                ...
                ('numberofactions', 'numberOfActions', nullable_int),
                ...
                ('numberofemployees', 'numberOfEmployees', nullable_int),
                ('research', 'research', splitCode),
                ('annualrevenue', 'annualRevenue', nullable_float),
                ...
                ('numberofoffersreceived', 'numberOfOffersReceived', nullable_int),
                ...
                ('fiscal_year', 'fiscal_year', nullable_int),
