...
CSV_SQL_MAPPING = [('contributionid', 'c.ContributionID', parse_int_id),
                ...
                ('contributor_id', 'c.NewContributorID', parse_int_id),
                ('newemployerid', 'c.NewEmployerID', parse_int_id),
                ('parentcompanyid', 'c.ParentCompanyID', parse_int_id),
                ('unique_candidate_id', 'cand.UniqueCandidateID', parse_int_id),
                ('candidate_id', 'r.CandidateID', parse_int_id),
                ('committee_id', 'r.CommitteeID', parse_int_id),
