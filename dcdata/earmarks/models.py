...
class Earmark(models.Model):
    ...
    house_parties = models.CharField(max_length=64, blank=True)
    house_states = models.CharField(max_length=64, blank=True)
    house_districts = models.CharField(max_length=64, blank=True)
    senate_members = models.CharField(max_length=512, blank=True)
    senate_parties = models.CharField(max_length=64, blank=True)
    senate_states = models.CharField(max_length=64, blank=True)
