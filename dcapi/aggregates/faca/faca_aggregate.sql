...
select org_id, agency_abbr, agency_name, committee_name, member_firstlast as member_name, chair, affiliation, min(start_date) as start_date, max(end_date) as end_date
