    ...
    def test_service_metadata(self):
        ...
        self.assertEqual(100,
            fuzz.token_sort_ratio(
                'jsonp123({"name": "Influence Explorer Reconciliation", "identifierSpace": "http://www.influenceexplorer.com/ns/entities", "schemaspace": "http://www.influenceexplorer.com/ns/entity.object.id", "view": { "url": "http://www.influenceexplorer.com/{{type}}/x/{{id}}" }, "preview": { "url": "http://www.influenceexplorer.com/{{type}}/x/{{id}}", "width": 430, "height": 300 }, "defaultTypes": []})',
                response.content
            )
        )
